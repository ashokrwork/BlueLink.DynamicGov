...
namespace OneHub360.CMS.Services.WOPI.FileSystem
{
    /// <summary>
    ...
    /// </remarks>
    public class WopiFileHandler : IHttpHandler
    {
        ...
        //internal const string LocalStoragePath = ;
        ...
        private static bool ValidateAccess(WopiRequest requestData, bool writeAccessRequired)
        {
            ...
            return true;// !String.IsNullOrWhiteSpace(requestData.AccessToken);
        }
