OneHub360.controller('incomingLettersController',
    ['$scope', '$rootScope', '$http', '$timeout', 'ngToast', '$state', '$notification', function
        ($scope, $rootScope, $http, $timeout, ngToast, $state, $notification) {

        var feedWebApiCallUrl = cmsContext.cmsServiceBaseUrl + 'cms/incomingletter/filter/';
        var feedWebApiCountCallUrl = cmsContext.cmsServiceBaseUrl + 'cms/incomingletter/getcount/';
