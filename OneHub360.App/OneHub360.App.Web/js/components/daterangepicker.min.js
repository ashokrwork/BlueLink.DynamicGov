 ...
 * Original file: /npm/daterangepicker2@3.1.0/daterangepicker2.js
 *
...
!function (t, e) {
    if ("function" == typeof define && define.amd)
        ...
        t.daterangepicker2 = e(t.moment, t.jQuery)
}(this, function (t, e) {
    var a = function (a, i, s) {
        ...
        "function" == typeof s && (this.callback = s),
            ...
            this.container.find(".drp-calendar").on("click.daterangepicker2", ".prev", e.proxy(this.clickPrev, this)).on("click.daterangepicker2", ".next", e.proxy(this.clickNext, this)).on("mousedown.daterangepicker2", "td.available", e.proxy(this.clickDate, this)).on("mouseenter.daterangepicker2", "td.available", e.proxy(this.hoverDate, this)).on("change.daterangepicker2", "select.yearselect", e.proxy(this.monthOrYearChanged, this)).on("change.daterangepicker2", "select.monthselect", e.proxy(this.monthOrYearChanged, this)).on("change.daterangepicker2", "select.hourselect,select.minuteselect,select.secondselect,select.ampmselect", e.proxy(this.timeChanged, this)),
            this.container.find(".ranges").on("click.daterangepicker2", "li", e.proxy(this.clickRange, this)),
            this.container.find(".drp-buttons").on("click.daterangepicker2", "button.applyBtn", e.proxy(this.clickApply, this)).on("click.daterangepicker2", "button.cancelBtn", e.proxy(this.clickCancel, this)),
            this.element.is("input") || this.element.is("button") ? this.element.on({
                "click.daterangepicker2": e.proxy(this.show, this),
                "focus.daterangepicker2": e.proxy(this.show, this),
                "keyup.daterangepicker2": e.proxy(this.elementChanged, this),
                "keydown.daterangepicker2": e.proxy(this.keydown, this)
            }) : (this.element.on("click.daterangepicker2", e.proxy(this.toggle, this)),
                this.element.on("keydown.daterangepicker2", e.proxy(this.toggle, this))),
            this.updateElement()
    };
    return a.prototype = {
        constructor: a,
        ...
        show: function (t) {
            this.isShowing || (this._outsideClickProxy = e.proxy(function (t) {
                ...
                e(document).on("mousedown.daterangepicker2", this._outsideClickProxy).on("touchend.daterangepicker2", this._outsideClickProxy).on("click.daterangepicker2", "[data-toggle=dropdown]", this._outsideClickProxy).on("focusin.daterangepicker2", this._outsideClickProxy),
                e(window).on("resize.daterangepicker2", e.proxy(function (t) {
                    this.move(t)
                }, this)),
        ...
        hide: function (t) {
            this.isShowing && (this.endDate || (this.startDate = this.oldStartDate.clone(),
                ...
                this.updateElement(),
                e(document).off(".daterangepicker2"),
                e(window).off(".daterangepicker2"),
                this.container.hide(),
        ...
        e.fn.daterangepicker2 = function (t, i) {
            var s = e.extend(!0, {}, e.fn.daterangepicker2.defaultOptions, t);
            return this.each(function () {
                var t = e(this);
                t.data("daterangepicker2") && t.data("daterangepicker2").remove(),
                    t.data("daterangepicker2", new a(t, s, i))
            }),
                this
        }
        ,
